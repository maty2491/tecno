    ...
    <>
      <div className="container-fluid mb-5 mt-5">
        <div className="row">
          ...
          <div className="col-lg-3 col-md-3 col-sm-12 text-center p-0">
            <img src={lateral} className="img-fluid " alt="Imagen Izquierda" />
          </div>

          {/* Texto centrado */}
          <div className="col-lg-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-center">
            <div className="text-center mt-4">
              <p className="fw-bold fs-1">I+D+I</p>
              <div className="fs-5">
              <p>
          ...
          <div className="col-lg-3 col-md-3 col-sm-12 p-0 text-center">
            <img src={lateral} className="img-fluid " alt="Imagen Derecha" />
          </div>
        </div>
      </div>
