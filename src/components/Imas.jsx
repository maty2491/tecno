  ...
  return (
    ...
    <div className="row border">
      <div className="col-lg-3 col-md-3 text-center">
        <img src={lateral} className="img-fluid mx-auto" width={300} alt="" />
      ...
      <div className="col-lg-6 col-md-6 d-flex align-items-center justify-content-center">
            <div className="text-center ">
              ...
              <div>
                <p>
                  La innovación sucede cuando se unen la biología, la agronomía
                  y la ​tecnología, con más de 30 años de experiencia y
                  formación, ​comprendiendo los ritmos y ciclos de la
                  naturaleza, sus conexiones ​e interrelaciones, para generar
          ...
          <div className="col-lg-3 col-md-3 text-center">
            <img src={lateral} className="img-fluid mx-auto" width={300}/>
          </div>
          </div>
    </div>     
          ...
          <div className="row">
            <div className="col-lg-10 col-md-12 ">
              ...
              <h5 className="text-light">
                ...
                crecimiento sobre la superficie del suelo, <br /> ​pero debajo,
                el crecimiento de las raíces es igual de significativo e
                intenso.{" "}
              </h5>
              <h5 className="text-light">
